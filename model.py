...
checkpointer = ModelCheckpoint('model_best_1.h5', monitor='val_loss', verbose=1, save_best_only=True)
...
#history_object = model.fit_generator(train_generator, samples_per_epoch=len(train_samples), verbose=1, validation_data=validation_generator, nb_val_samples=len(validation_samples), nb_epoch=EPOCHS)
